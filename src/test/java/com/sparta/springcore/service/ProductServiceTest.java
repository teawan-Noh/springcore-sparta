...
class ProductServiceTest {
    ...
    void updateProduct_Normal() {
        ...
        when(productRepository.findById(productId))  // test case 이므로 productId를 던지면 해당 데이터를 찾을 수 없다
                .thenReturn(Optional.of(product));  // 따라서 Optional.of(product)를 반환하도록 처리
